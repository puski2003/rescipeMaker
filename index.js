...
app.post("/submit", (req, res) => {
  function generateName(){
    var randNum1 = parseInt(Math.random()*adj.length);
    var randNum2 =parseInt(Math.random()*noun.length);
    var fname= adj[randNum1];
    var lname= noun[randNum2];
    
    return {fname,lname};
  }
  var Bname= generateName();
    console.log(Bname);

  var year = new Date().getFullYear;
    res.render("index.ejs",{
      bname:Bname.fname+" "+Bname.lname
